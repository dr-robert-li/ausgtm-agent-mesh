...
COMMON_SECRETS="${COMMON_SECRETS},LITELLM_MASTER_KEY=LITELLM_MASTER_KEY:latest"
COMMON_SECRETS="${COMMON_SECRETS},LITELLM_SHARED_SECRET=LITELLM_SHARED_SECRET:latest"
